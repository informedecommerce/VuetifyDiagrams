...
-->
        <v-text-field
            label="Text"
					  hide-details
					  v-if="tmpNode && !tmpNode.arrow && !tmpNode.shape == 'title' && tmpNode.shape != 'text' && tmpNode.shape != 'straight' || tmpNode.shape != 'bezier'"
    ...
    <v-expansion-panel v-if="editable">
      ...
      >
		...
		<v-list-item @click="isAskClearDiagram = true">
		 ...
		 <v-flex xs10 >
    <Diagram
			 style="max-height: calc(100vh - 200px);max-width: calc(100vw - 500);overflow: auto"
